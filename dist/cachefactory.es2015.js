...
class CacheFactory$1 {
  ...
  createCache (id, options = {}) {
    ...
    options.parent = this
    this.caches[id] = new CacheFactory$1.Cache(id, options)
  ...
  info () {
    ...
    Object.keys(CacheFactory$1.defaults).forEach((key, value) => {
      info[key] = CacheFactory$1.defaults[key]
    })
    return info
  }
